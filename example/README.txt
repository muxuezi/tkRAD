...
You should have *INSTALLED* current package before trying the
example script located in `example/example.py`.

To do this, open a Linux / UNIX-like shell console, go to the
directory handling `setup.py` file of your new package and type:

    $ sudo python3 setup.py install

System will ask for authentication and then will install your new
package at the right location.
